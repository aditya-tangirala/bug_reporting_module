	...
	<body>
		...
		$con=mysql_connect("localhost","root","4244");
			...
			{die(mysql_error());}
			   ...
			   $q1=mysql_query("select * from report where testcaseid='$tid'");
...
<div id="m_form_bg" style="margin-top:0%; ">
	   ...
	   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<input type="text" name="module" value="'.$r['module'].'" style="height:0px; width:0px; border:none; background:none;"> 
