...
<html>
	...
	<body>
		...
		<?php
			...
			$anmly_rpt=mysql_query("select * from report where pname='$proj'order by sno asc ");			
			...
			{   //echo $r['sno']."&nbsp;".$r['module']."&nbsp;".$r['testcaseid']."&nbsp;".$r['desc']."&nbsp;".$r['severity'];
				fwrite($file,$r['sno']."\t".$r['pname']."\t".$r['module']."\t".$r['testcaseid']."\t".$r['severity']."\t".$r['desc']."\n");
			}
			fclose($file);
		?>
	</body>
