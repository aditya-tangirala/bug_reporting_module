...
<div id="m_form_bg" style="margin-top:0%; ">
		...
		<u><b><p style="font-family:Century Gothic; font-size:20;">Available Project</p></b></u> 
	...
	<?php 
			...
			{die(mysql_error());}
			  ...
			  mysql_select_db("anomoly_report",$con);
			   $name=$_SESSION['name'];
			   $q1=mysql_query("select distinct pname from module_assgn where assgn='$name'");
			   $count=0;
			   echo '<form action="report_pre2.php" method="post">';
